...
class Ui_HRM_Signup_view(object):
    def setupUi(self, HRM_Signup_view):
        ...
        HRM_Signup_view.resize(741, 507)
        HRM_Signup_view.setStyleSheet("background-color:rgb(40, 93, 117);color:rgb(0, 255, 255)")
        self.layoutWidget = QtWidgets.QWidget(HRM_Signup_view)
        self.layoutWidget.setGeometry(QtCore.QRect(130, 60, 451, 381))
        ...
        self.lineEdit_pswrd = QtWidgets.QLineEdit(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("System")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.lineEdit_pswrd.setFont(font)
        ...
        self.lineEdit_cpswrd = QtWidgets.QLineEdit(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("System")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.lineEdit_cpswrd.setFont(font)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 20, 73, 50))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.layoutWidget_2)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.radioButton_m = QtWidgets.QRadioButton(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        ...
        self.radioButton_f = QtWidgets.QRadioButton(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(82)
        sizePolicy.setVerticalStretch(17)
        ...
        self.label_11 = QtWidgets.QLabel(HRM_Signup_view)
        self.label_11.setGeometry(QtCore.QRect(100, 10, 581, 41))
        font = QtGui.QFont()
        ...
        self.label_2 = QtWidgets.QLabel(HRM_Signup_view)
        self.label_2.setGeometry(QtCore.QRect(10, 0, 731, 511))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../images/icons/bground1.jpg"))
    ...
    def retranslateUi(self, HRM_Signup_view):
        ...
        HRM_Signup_view.setWindowTitle(_translate("HRM_Signup_view", "New User"))
