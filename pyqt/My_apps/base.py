...
class Ui_HRM_Dashboard_view(object):
    def setupUi(self, HRM_Dashboard_view):
        ...
        HRM_Dashboard_view.resize(1364, 713)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../images/logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        HRM_Dashboard_view.setWindowIcon(icon)
        HRM_Dashboard_view.setToolTip("")
        HRM_Dashboard_view.setStatusTip("")
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(9, 10, 801, 31))
        ...
        self.toolButton_7 = QtWidgets.QToolButton(self.layoutWidget_4)
        ...
        self.toolButton_print = QtWidgets.QToolButton(self.layoutWidget_4)
        self.toolButton_print.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../images/printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_print.setIcon(icon7)
        ...
        self.toolButton_10 = QtWidgets.QToolButton(self.layoutWidget_4)
        ...
        self.label_welcome_username = QtWidgets.QLabel(self.centralwidget)
        self.label_welcome_username.setGeometry(QtCore.QRect(250, 620, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Monotype Corsiva")
        font.setPointSize(20)
        font.setItalic(False)
        font.setUnderline(True)
        self.label_welcome_username.setFont(font)
        self.label_welcome_username.setObjectName("label_welcome_username")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(180, 620, 41, 41))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap("../images/key-to-success.png"))
        self.label_5.setScaledContents(True)
        self.label_5.setWordWrap(False)
        self.label_5.setIndent(0)
        self.label_5.setObjectName("label_5")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(10, 50, 71, 61))
        self.label_3.setMinimumSize(QtCore.QSize(48, 50))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("../images/logo.png"))
        self.label_3.setObjectName("label_3")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(80, 50, 600, 61))
        ...
        self.pushButton_user_login = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_user_login.setGeometry(QtCore.QRect(20, 130, 225, 68))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        ...
        self.pushButton_user_login.setStyleSheet("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../images/user-10.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_user_login.setIcon(icon8)
        self.pushButton_user_login.setIconSize(QtCore.QSize(60, 60))
        self.pushButton_user_login.setObjectName("pushButton_user_login")
        self.pushButton_user_reg = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_user_reg.setGeometry(QtCore.QRect(20, 240, 261, 68))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.pushButton_user_reg.setStyleSheet("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../images/user-13.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_user_reg.setIcon(icon9)
        self.pushButton_user_reg.setIconSize(QtCore.QSize(60, 60))
        self.pushButton_user_reg.setObjectName("pushButton_user_reg")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(20, 360, 221, 68))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(11)
        font.setBold(True)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../images/icons/international-connection.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_4.setIcon(icon10)
        self.pushButton_4.setIconSize(QtCore.QSize(60, 60))
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_exit_app = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_exit_app.setGeometry(QtCore.QRect(80, 490, 94, 48))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_exit_app.setFont(font)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../images/thin-expand-arrows.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_exit_app.setIcon(icon11)
        self.pushButton_exit_app.setIconSize(QtCore.QSize(40, 40))
        self.pushButton_exit_app.setObjectName("pushButton_exit_app")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(10, 50, 1331, 621))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../images/icons/index.png"))
        ...
        self.label_4.raise_()
        self.label_welcome_username.raise_()
        self.label_5.raise_()
        self.label_3.raise_()
        self.label.raise_()
        self.pushButton_user_login.raise_()
        self.pushButton_user_reg.raise_()
        self.pushButton_4.raise_()
        self.pushButton_exit_app.raise_()
        ...
        self.menuBilling = QtWidgets.QMenu(self.menuPayments)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("../images/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionWorker_2.setIcon(icon12)
        ...
        self.actionBilling = QtWidgets.QAction(HRM_Dashboard_view)
        self.actionBilling.setObjectName("actionBilling")
        self.actionEarnings_2 = QtWidgets.QAction(HRM_Dashboard_view)
        self.actionEarnings_2.setObjectName("actionEarnings_2")
        self.actionDeductions_2 = QtWidgets.QAction(HRM_Dashboard_view)
        self.actionDeductions_2.setObjectName("actionDeductions_2")
        ...
        self.menuBilling.addAction(self.actionEarnings_2)
        self.menuBilling.addAction(self.actionDeductions_2)
        self.menuPayments.addAction(self.menuBilling.menuAction())
    ...
    def retranslateUi(self, HRM_Dashboard_view):
        ...
        self.toolButton_7.setToolTip(_translate("HRM_Dashboard_view", "System Services"))
        self.toolButton_7.setStatusTip(_translate("HRM_Dashboard_view", "Services"))
        self.toolButton_8.setToolTip(_translate("HRM_Dashboard_view", "System Records"))
        self.toolButton_8.setStatusTip(_translate("HRM_Dashboard_view", "Meetings"))
        self.toolButton_9.setToolTip(_translate("HRM_Dashboard_view", "system Settings"))
        self.toolButton_9.setStatusTip(_translate("HRM_Dashboard_view", "System Settings"))
        self.toolButton_print.setStatusTip(_translate("HRM_Dashboard_view", "Print"))
        self.toolButton_10.setToolTip(_translate("HRM_Dashboard_view", "system Users"))
        self.toolButton_10.setStatusTip(_translate("HRM_Dashboard_view", "System Users"))
        self.toolButton_11.setToolTip(_translate("HRM_Dashboard_view", "system Error correction"))
        self.toolButton_11.setStatusTip(_translate("HRM_Dashboard_view", "Error Debugging"))
        self.toolButton_help.setToolTip(_translate("HRM_Dashboard_view", "Need Help"))
        self.toolButton_help.setStatusTip(_translate("HRM_Dashboard_view", "Help"))
        self.label_4.setText(_translate("HRM_Dashboard_view", "Welcome :"))
        self.label_welcome_username.setText(_translate("HRM_Dashboard_view", "Please Login to Proceed!!!"))
        ...
        self.pushButton_exit_app.setText(_translate("HRM_Dashboard_view", "Exit"))
        ...
        self.menuBilling.setTitle(_translate("HRM_Dashboard_view", "Billing"))
        ...
        self.actionBilling.setText(_translate("HRM_Dashboard_view", "Billing"))
        self.actionEarnings_2.setText(_translate("HRM_Dashboard_view", "Earnings"))
        self.actionDeductions_2.setText(_translate("HRM_Dashboard_view", "Deductions"))
